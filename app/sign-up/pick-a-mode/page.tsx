...
export default function PickAModePage() {
  ...
  const handleSignIn = (provider: 'google' | 'outlook') => {
    // Mock successful authentication
    // In production, this would handle actual OAuth flow
    router.push('/sign-up/defines-you-best')
  }
  ...
  return (
    <div className="min-h-screen w-full relative bg-black overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col items-center justify-center min-h-screen gap-4">
        {/* Sign up card */}
        <div className="w-[695px] h-[361px] relative bg-black/80 rounded-[40px] opacity-90 overflow-hidden md:translate-y-0 translate-y-[-10%]">
          ...
          <div className="left-[428px] top-[141px] absolute flex-col justify-start items-start gap-4 inline-flex">
            <button
              ...
              className="self-stretch px-6 py-2 bg-white rounded-xl shadow-[0px_1px_1px_0px_rgba(0,0,0,0.17)] justify-center items-center gap-2.5 inline-flex overflow-hidden hover:bg-gray-50 transition-colors"
            >
            ...
            <button
              ...
              className="self-stretch px-4 py-2 bg-white rounded-xl shadow-[0px_1px_1px_0px_rgba(0,0,0,0.17)] justify-center items-center gap-2.5 inline-flex overflow-hidden hover:bg-gray-50 transition-colors"
            >
        ...
        {/* Animated cards */}
        <div className="absolute bottom-24 left-0 w-full overflow-hidden md:translate-y-0 translate-y-[20%]">
          <div className="px-7">
            <AnimatedCards />
          </div>
        </div>
